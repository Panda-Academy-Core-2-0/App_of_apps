            ...
            steps {
                dir('Terraform') {                
                    ...
                    withAWS(credentials:'AWS', region: 'us-east-1') {
                            sh 'terraform init -backend-config=bucket=panda-academy-panda-devops-core-1'
                            sh 'terraform apply -auto-approve -var bucket_name=panda-academy-panda-devops-core-1
